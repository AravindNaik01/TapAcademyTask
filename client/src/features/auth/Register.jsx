          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 bg-gray-50 text-gray-600 rounded-md cursor-not-allowed sm:text-sm font-mono"
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Employee ID format will be {formData.role === 'manager' ? 'MGR' : 'EMP'}XXX
              </p>
            </div>
            <div>
